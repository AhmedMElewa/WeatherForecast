package com.forecast.weather.weatherforecast.activities;
...
import com.forecast.weather.weatherforecast.TodayTomorrowWeather;
import com.forecast.weather.weatherforecast.adapters.ViewPagerAdapter;
import com.forecast.weather.weatherforecast.adapters.WeatherRecyclerAdapter;
import com.forecast.weather.weatherforecast.models.Weather;
import com.forecast.weather.weatherforecast.tasks.GenericRequestTask;
import com.forecast.weather.weatherforecast.tasks.ParseResult;
import com.forecast.weather.weatherforecast.tasks.TaskOutput;
...
public class MainActivity extends AppCompatActivity implements LocationListener {
    ...
    private static final int NO_UPDATE_REQUIRED_THRESHOLD = 500000;
    ...
    private void saveLocation(String result) {
        ...
        recentCity = preferences.getString("city", "london");
    ...
    private void aboutDialog() {
        AlertDialog.Builder alert = new AlertDialog.Builder(this);
        alert.setTitle("weather forecast application");
        final WebView webView = new WebView(this);
        String about = "Created by Ahmed Elewa";
...
//        TodayTomorrowWeather todayWeather = new TodayTomorrowWeather();
//        todayWeather.setArguments(bundleToday);
//        viewPagerAdapter.addFragment(todayWeather, getString(R.string.today));

        Bundle bundleTomorrow = new Bundle();
        bundleTomorrow.putInt("day", 1);
        TodayTomorrowWeather tomorrowWeather = new TodayTomorrowWeather();
        tomorrowWeather.setArguments(bundleTomorrow);
        viewPagerAdapter.addFragment(tomorrowWeather, getString(R.string.tomorrow));

        Bundle bundle = new Bundle();
        bundle.putInt("day", 2);
        TodayTomorrowWeather recyclerViewFragment = new TodayTomorrowWeather();
